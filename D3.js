...
console.log("nome", charactersNames);
*/
/* ESERCIZIO 3
...
console.log("fem", femaleCharacters);
*/
/* ESERCIZIO 4
...
console.log("nuovig", starWarsCharacters);
/* --EXTRA-- ESERCIZIO 9
